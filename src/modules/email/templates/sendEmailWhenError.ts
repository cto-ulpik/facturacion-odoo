...
export async function sendEmailWhenError(props:any){
  ...
  const mailOptions = {
    to: 'cpa@ulpik.com',
    cc: 'cto@ulpik.com',
    subject: 'NOTIFICACIÓN | Hubo un Error al Generar una Factura por Pago en Automático',
    text: 'Hubo un Error al Generar una Factura',
    html:`
    <p>Hola Estimada CPA</p>
    <p>Hubo un Error al Generar una Factura de la siguiente persona:</p>
    ${dataBill}
    <p>Saludos,</p>
    `
  };
